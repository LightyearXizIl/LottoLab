...
<style scoped>
.view{display:grid;gap:1.25rem}.eyebrow{margin:0;color:var(--ink-muted);font-size:.67rem;font-weight:800;letter-spacing:.1em}h1{margin:.3rem 0;font-size:1.55rem}p:not(.eyebrow){margin:0;color:var(--ink-soft);font-size:.85rem}.card{border:1px solid var(--line);border-radius:.9rem;padding:1.1rem;background:#fff;box-shadow:var(--card-shadow)}.empty{display:grid;gap:.35rem;place-items:center;padding:3.5rem;color:var(--ink-soft);font-size:.85rem;text-align:center}.empty strong{color:var(--ink);font-size:1rem}.saved{display:grid;gap:.75rem}.saved article{display:grid;gap:.8rem;overflow:hidden;border:1px solid var(--line);border-radius:.7rem;padding:.85rem;background:#fafcff}.saved-head{display:flex;justify-content:space-between;gap:1rem}.saved-head strong,.saved-head span{display:block}.saved-head strong{font-size:.88rem}.saved-head span,.saved-head small,.seed{margin-top:.2rem;color:var(--ink-muted);font-size:.68rem}.sets{display:grid;gap:.5rem}.sets>div{display:flex;align-items:center;gap:.6rem}.sets b{display:grid;width:1.5rem;height:1.5rem;place-items:center;border-radius:99px;background:#edf2f8;color:var(--ink-soft);font-size:.68rem}.balls{display:flex;flex-wrap:wrap;gap:.25rem}.seed{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}button{min-height:2.75rem;margin-top:1rem;border:1px solid var(--line);border-radius:.5rem;padding:.55rem .7rem;background:#fff;color:var(--ink-soft);font:inherit;cursor:pointer}.message{margin-top:.7rem!important;color:#18885f!important;font-size:.76rem!important}@media(max-width:600px){.card{padding:.9rem}.saved-head{display:grid;gap:.2rem}.sets>div{align-items:flex-start}.empty{padding:2.5rem 1rem}}
</style>
