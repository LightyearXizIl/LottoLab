...
<style scoped>.view{display:grid;gap:1.25rem}header{display:flex;justify-content:space-between;align-items:center;gap:1rem}.eyebrow{margin:0;color:var(--ink-muted);font-size:.67rem;font-weight:800;letter-spacing:.1em}h1{margin:.3rem 0;font-size:1.55rem}p:not(.eyebrow){margin:0;color:var(--ink-soft);font-size:.85rem}.card{border:1px solid var(--line);border-radius:.9rem;padding:1.1rem;background:#fff;box-shadow:var(--card-shadow)}.controls{display:flex;align-items:end;gap:.8rem}.controls label{display:grid;gap:.3rem;color:var(--ink-soft);font-size:.78rem;font-weight:650}.controls select{min-height:2.75rem;border:1px solid var(--line);border-radius:.5rem;padding:.55rem;background:#fff;font:inherit}.controls button{min-height:2.75rem;border:0;border-radius:.55rem;padding:.65rem .85rem;background:#16253d;color:#fff;font:inherit;font-weight:700;cursor:pointer}.controls .cancel{background:#fff1f2;color:#a61c36;border:1px solid #f3c4c9}.progress-card{display:grid;gap:.7rem}.progress-card>div{display:flex;justify-content:space-between;gap:1rem}.progress-card span,.progress-card small{color:var(--ink-muted);font-size:.75rem}.progress-card progress{width:100%;height:.7rem;accent-color:#c81e3a}.summary{display:grid;grid-template-columns:repeat(3,1fr);gap:.8rem}.summary article{padding:.8rem;border-radius:.7rem;background:#f8fafc}.summary span,.summary small{display:block;color:var(--ink-muted);font-size:.72rem}.summary strong{display:block;margin:.35rem 0;font-size:1.45rem}.notice{margin:1rem 0 0!important;padding:.7rem;border-left:3px solid #e9a128;background:#fffbeb;color:#795b1d!important;font-size:.78rem!important}.empty{color:var(--ink-soft);font-size:.85rem}.error{margin:0;padding:.7rem .9rem;border:1px solid #f3c4c9;border-radius:.6rem;background:#fff1f2;color:#a61c36;font-size:.8rem}@media(max-width:800px){header{align-items:flex-start;flex-direction:column}.summary{grid-template-columns:1fr}.controls{align-items:stretch;flex-direction:column}.controls button,.controls select{width:100%}.progress-card>div{display:grid;gap:.2rem}}</style>
